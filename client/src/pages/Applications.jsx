    ...
    <>
      ...
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
         ...
         <div className='flex gap-2 mb-6 mt-3'>
          ...
          <h2 className='text-xl font-samibold mb-4'>Job applied</h2>
          <table className='min-w-full border bg-white rounded-lg'>
            ...
            <tbody>
              ...
              <tr key={index}>
                ...
                <td className='px- py-2 border-b'>{job.jobId.title}</td>
                <td className='px- py-2 border-b max-sm:hidden'>{job.jobId.location}</td>
                <td className='px- py-2 border-b max-sm:hidden'>{moment(job.date).format('ll')}</td>
                <td className='px- py-2 border-b'>
